...
LIMIT 10;
```
![Customers_with_most_orders](assets\Customers_with_most_orders_chart_2.png)
...
```
![Most_used_Payment_Mode](assets\Most_used_payment_method.PNG)
...
```
![Revenue_generated_by_products](assets\Revenue_generated_by_products.png)
...
LIMIT 25;
```
![average_qty_and_profit](assets\average_qty_and_profit.png)
...
**key insights:**
 ...
 -   Distribution of Total Profit Made:
        ...
        ![Distribution_of_total_profit_made](assets\Distribution_of_total_profit_made.png)
...
```
![total_orders_and_Qty](assets\total_orders_&_qty.png)
...
```
![Total_orders_by_quarter](assets\Total_orders_by_quarter.png)
